			...
			<form className="form-detail" action="#" method="post" id="myform">
				<div className="form-left">
					...
					<datalist id="dataclient">
						...
						{/* <select name="title" className="input-text">
						    <option  value="title">Choisir le client</option>
                    ...
                    <div className="form-row">
							<input type="number" name="business" className="business" id="business" placeholder="Montant à transferer" required/>
						</div>
                    <div className="form-group">
                        <div className=" form-row form-row-1">
                            <span className="input-group-text text-center">
                            XAF <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-down-up mx-auto" viewBox="0 0 16 16">
                        ...
                        <div className=" form-row form-row-2">
                            <span className="input-group-text text-center">
                                Taux : <span className='mx-auto'> 1 XAF = 1 XAF </span>
                            </span>
                        </div>
                    </div>
                    <div className="form-row">
				...
				<div className="form-right">
					...
					<div className="form-row">
                        <input type="text" name="nomreceiver" class="input-text" id="nomreceiver" placeholder="Nom Complet du destinataire" required/>
					</div>
					<div className="form-row">
					...
					{/* <div className="form-row">
						<input type="text" name="ville" id="ville" className="input-text" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}" placeholder="Your Email"/>
					</div> */}
                    <div className="form-row">
